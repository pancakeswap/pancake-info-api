...
function replaceEnv(content) {
    ...
    return content.replace(R, function (_, result) {
        var _a = result.split(':'), name = _a[0], value = _a[1], rest = _a.slice(2);
        if (value) {
            if (rest && rest.length) {
                value = tslib.__spreadArrays([value], rest).join(':');
            }
            value = value.trim();
            if (value.startsWith("\"")) {
...
var LoadersRegistry = /** @class */ (function () {
    ...
    LoadersRegistry.prototype.loadTypeDefs = function (pointer, options) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                return [2 /*return*/, core.loadTypedefs(pointer, tslib.__assign({ loaders: this._loaders, cwd: this.cwd }, options))];
            });
        });
    };
    LoadersRegistry.prototype.loadTypeDefsSync = function (pointer, options) {
        return core.loadTypedefsSync(pointer, this.createOptions(options));
    };
    LoadersRegistry.prototype.loadDocuments = function (pointer, options) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                return [2 /*return*/, core.loadDocuments(pointer, this.createOptions(options))];
            });
        });
    };
    LoadersRegistry.prototype.loadDocumentsSync = function (pointer, options) {
        return core.loadDocumentsSync(pointer, this.createOptions(options));
    };
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (out === 'GraphQLSchema' && !this._middlewares.length) {
                            return [2 /*return*/, core.loadSchema(pointer, options)];
                        }
                        _a = this.transformSchemaSources;
                        return [4 /*yield*/, core.loadTypedefs(pointer, tslib.__assign({ filterKinds: core.OPERATION_KINDS }, options))];
                    case 1:
    ...
    LoadersRegistry.prototype.loadSchemaSync = function (pointer, out) {
        ...
        if (out === 'GraphQLSchema' && !this._middlewares.length) {
            return core.loadSchemaSync(pointer, options);
        }
        var schemaDoc = this.transformSchemaSources(core.loadTypedefsSync(pointer, tslib.__assign({ filterKinds: core.OPERATION_KINDS }, options)));
