...
function instrument(fn, name) {
  ...
  var profileName = (_ref = name !== null && name !== void 0 ? name : // $FlowFixMe - Flow no longer considers statics of functions as any
...
function instrumentAsyncContext(fn, name) {
  ...
  var profileName = (_ref2 = name !== null && name !== void 0 ? name : // $FlowFixMe - Flow no longer considers statics of functions as any
...
function instrumentWait(fn, name) {
  ...
  var profileName = (_ref3 = name !== null && name !== void 0 ? name : // $FlowFixMe - Flow no longer considers statics of functions as any
