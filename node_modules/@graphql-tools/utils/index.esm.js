...
import { mapSchema as mapSchema$1, MapperKind as MapperKind$1 } from '@graphql-tools/utils';
...
function pruneSchema(schema, options = {}) {
    ...
    return mapSchema$1(schema, {
        [MapperKind$1.TYPE]: (type) => {
            if (isObjectType(type) || isInputObjectType(type)) {
